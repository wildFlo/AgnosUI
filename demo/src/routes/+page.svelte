...
<div class="container-xxl flex flex-col items-center md:pt-12">
	<div class="flex md:flex-row flex-col">
		<div class="md:order-1 order-2">
			<h1 class="text-primary-emphasis sm:text-start text-center sm:fs-1 md:mb-12 mb-4">
				<span
			...
			<h2 class="text-primary-emphasis sm:text-start text-center">Perfected component libraries</h2>
		...
		<div class="card-text btn-grid">
			<div>
				<a
					...
					class="btn btn-outline btn-primary rounded-pill flex items-center justify-start sm:px-3"
