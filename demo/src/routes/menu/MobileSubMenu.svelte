...
<div class="flex items-center justify-content-between">
	<button
		class="d-md-none text-dark-emphasis flex items-center btn btn-link link-underline link-underline-opacity-0"
	...
	<button
		class="text-dark-emphasis flex items-center btn btn-link link-underline link-underline-opacity-0"
